...
export const ui = {
  en: {
    ...
    'contact.subtitle': 'I\'m always open to discussing new opportunities, collaborations, tutoring services, or just a friendly chat about engineering and education.',
    'contact.connect': 'Let\'s Connect',
    'contact.form.name': 'Jméno',
    'contact.form.email': 'E-mail',
    'contact.form.subject': 'Předmět',
    'contact.form.message': 'Zpráva',
    'contact.form.send': 'Odeslat E-mail', 'nav.contact': 'Contact',
    'nav.portfolio': 'Vojtěch De Coninck',
    'nav.welcome': 'Welcome!',
  ...
  da: {
    ...
    'contact.connect': 'Lad os Forbinde',
